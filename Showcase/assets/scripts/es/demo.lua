...
local function technical()
	...
	s "Este motor está inspirado un poco en el Siglus, en lo que se puede aprender de él viéndolo funcionar en otros juegos y estudiando sus archivos de configuración."
